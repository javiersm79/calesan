			...
			<section id="seccionprimaria" class="main-content">
				...
				<div class="form-group">
				  <label for="factor">Factor:</label>
				   <input type="number" name="factor" id="factor" value="1" style="width: 55px"> %
				</div>
				<div class="form-group">
				  <label for="logo">Logo:</label>
				   <select id="logo">
					  <option value="calesan" selected>CALESAN</option>
				...
				<div class="btn-group">
					...
					<form class="hidden" action="tienda/imprimircatalogopublico.php" method="post">
					...
					<a type="button" id="ayudabtn" class="btn btn-primary" href="themes/images/ayudacatalogo/img1.png" data-fancybox="images-single">Ayuda</a>
