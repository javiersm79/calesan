									...
									?>	
												<li class="span2">
													<div class="product-box">
														...
														<p><a href="subcategoria.php?categoria=<?=$filas['codigo'];?>"><img class="circular-image" src="themes/images/categorias/<?=$filas['imagen']?>"  /></a></p>
														<a href="subcategoria.php?categoria=<?=$filas['codigo'];?>" class="title"><?=$filas['nombre'];?></a><br/>
