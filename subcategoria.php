							...
							<div class="span9">
								<div id="familiaProducto">
									<?php 
										if ($sc > 0){
											if(isset($_GET["subcategoria"])) {
												$consulta = "SELECT * FROM maestraproducto where codigocat = $_GET[categoria] and codigosubcat like '$_GET[subcategoria]' and inactivo = 0 and estadosupercat = 'Activo' and estadocat = 'Activo' order by `ordenproducto`";  
												//$consulta = "SELECT * FROM maestraproducto where codigocat = $_GET[categoria] and codigosubcat like '$_GET[subcategoria]' and inactivo = 0 and estadosupercat = 'Activo' and estadocat = 'Activo' order by `ordenproducto`,`descripcionproducto`";  

											}
											else{
												 $consulta = "SELECT * FROM maestraproducto where codigocat = $_GET[categoria] and inactivo = 0 and codigosubcat=".$subcategorias[0]->getCodigo()." and estadosupercat = 'Activo' and estadocat = 'Activo' order by `ordenproducto`"; 
												 //$consulta = "SELECT * FROM maestraproducto where codigocat = $_GET[categoria] and inactivo = 0 and codigosubcat=".$subcategorias[0]->getCodigo()." and estadosupercat = 'Activo' and estadocat = 'Activo' order by `ordenproducto`,`descripcionproducto`"; 
